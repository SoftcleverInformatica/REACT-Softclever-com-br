				...
				<div className="flex w-full flex-col gap-8 sm:max-w-3xl lg:max-w-screen-lg lg:flex-row">
					<div className="flex w-full flex-col gap-8 self-center lg:max-w-[67%] lg:flex-row">
						<p className="w-full text-base font-medium text-[#3c4a54]">
							...
							parcerias estabelecidas com escritórios de contabilidade, comprometemo-nos em fornecer serviços cada vez melhores. Nosso compromisso
							com a excelência e o foco no bem-estar dos clientes são os pilares que norteiam nossa atuação. Isso se reflete na confiança e
							satisfação demonstradas por nossos clientes em cada interação.
						</p>
						<p className="w-full text-base font-medium text-[#3c4a54]">
