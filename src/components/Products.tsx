		...
		<div className="item-center flex w-full max-w-lg flex-col justify-center gap-8 p-8 sm:py-16 lg:max-w-screen-lg lg:flex-row lg:gap-0 xl:px-0">
			<div className="flex w-full flex-col gap-8 sm:max-w-3xl lg:max-w-screen-lg">
				...
				<div className="flex w-full flex-col gap-8 sm:max-w-3xl lg:max-w-screen-lg lg:flex-row">
					<div className="flex w-full flex-col items-stretch justify-between gap-8 rounded-lg bg-cyan-100 p-12 shadow-product lg:max-w-[32%]">
						...
						<Link
							...
							className="rounded border-2 border-second p-2 text-center text-second transition-all hover:border-third hover:text-sm hover:text-third hover:shadow-[0_10px_24px_rgba(0,0,0,0.3)]"
							target="_blank"
						>
							Consulte valores
						</Link>
					</div>
					<div className="flex w-full flex-col items-stretch justify-between gap-8 rounded-lg bg-third p-12 shadow-product lg:max-w-[32%]">
					...
					<div className="flex w-full flex-col items-stretch justify-between gap-8 rounded-lg bg-second  p-12 shadow-product lg:max-w-[32%]">
						...
						<Link
							...
							className="rounded border-2 border-white p-2 text-center text-white transition-all hover:border-third hover:text-sm hover:text-third hover:shadow-[0_10px_24px_rgba(0,0,0,0.3)]"
							target="_blank"
						>
							Consulte valores
						</Link>
